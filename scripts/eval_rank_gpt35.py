...
if __name__ == '__main__':
    ...
    prompt = """
        你是一个打分员，需要对两个模型针对用户指令给出的回答进行比较排序。你需要对比两个输出语句，来分别对模型的回答进行排序。请按照\"第一:\n第二:\n原因:\n\"这样的形式输出排序结果。评价标准要求回答的结果越合理越友善越有意义则排在前面。\n\n
    """
    ...
    for i in range(len(q_data)):
        ...
        exmresponse1 = """第一:回答1\n第二:回答2\n原因:从回答质量上看回答1的回答更有意义并且更合理；回答2不够友善并且给出错误机场代码；所以回答1排第一，回答2排第二"""
        ...
        exmresponse2 = """第一:回答2\n第二:回答1\n原因从回答质量上看回答1的回答符合问题要求但是没有回答2的丰富；回答2不仅给出了合理的回答并且给出了很多选项，回答更有意义也更合理；所以回答2排第一，回答1排第二"""
